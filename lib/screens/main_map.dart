...
class _MainMapState extends State<MainMap> {
  ...
  late List<CameraPosition> _kBusList;
  ...
  void initState() {
    ...
    _kBusList = List<CameraPosition>.generate(
        busses.length,
  ...
  _addSourceAndLineLayer(int index, bool removeLayer) async {
    ...
    controller.animateCamera(CameraUpdate.newCameraPosition(_kBusList[index]));
  ...
  _onStyleLoadedCallback() async {
    for (CameraPosition _kRestaurant in _kBusList) {
